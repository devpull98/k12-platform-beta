 ...
 * {@link com.uni.realtime.gateway.auth.TicketVerifier}'s javadoc). This is NOT the production
 * signing algorithm; it exists solely so this repo's own test tooling can mint a ticket
 * {@link com.uni.realtime.gateway.auth.dev.DevTicketVerifier} can verify, without waiting on the
