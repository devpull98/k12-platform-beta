 ...
 * com.uni.realtime.gateway.auth.TicketAuthHandler}, right after {@code ticketVerifier.verify}
 ...
 * com.uni.realtime.gateway.net.RateLimitHandler}'s in-game message limits (also keyed by
