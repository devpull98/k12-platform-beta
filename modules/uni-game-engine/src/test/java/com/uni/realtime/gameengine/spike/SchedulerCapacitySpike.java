package com.uni.realtime.gameengine.spike;
 ...
 * <pre>
 * mvn -pl :uni-game-engine test-compile
 * mvn -pl :uni-game-engine dependency:build-classpath -Dmdep.outputFile=target/cp.txt
 * java -XX:ActiveProcessorCount=2 -cp "target/classes;target/test-classes;$(cat target/cp.txt)" \
 *     com.uni.realtime.gameengine.spike.SchedulerCapacitySpike
 * </pre>
 */
